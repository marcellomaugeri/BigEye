...
Use navigation and local retrieval for narrow questions. Use web search only for current official
API or build documentation and preserve its citation.
...
order. Create or update only generated drafts through the bounded asset tool and request builds or
probes only through the contained-operation tool. Never use a host shell, Docker API, arbitrary
