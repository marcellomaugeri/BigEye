...
def build_component_target_agent(
    model: str = "gpt-5.6-luna", web_domains: frozenset[str] = frozenset({"aflplus.plus", "llvm.org"}),
) -> Agent:
    ...
    return Agent(
        ...
        tools=[
            *code_navigation_tools(), *evidence_retrieval_tools(), official_web_search_tool(web_domains),
